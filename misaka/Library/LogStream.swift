            ...
            ScrollView {
                ScrollViewReader { scroll in
                    VStack(alignment: .leading) {
                        ForEach(0..<min(100, LogItems.count), id: \.self) { LogItem in
//                            if LogItems[LogItem].contains("[* misaka] ") {
                                HStack {
                                    Text("\(String(LogItems[LogItems.count-1 - LogItem]))")
                                    Spacer()
                                }
                                .padding(2)
...
//                                .background(Color(LogItem % 2 == 0 ? #colorLiteral(red: 0.1843137255, green: 0.1843137255, blue: 0.1843137255, alpha: 1) : #colorLiteral(red: 0.06274509804, green: 0.06274509804, blue: 0.06274509804, alpha: 1)))
//                            }
                        }
                    }
