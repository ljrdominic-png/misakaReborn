...
extension LocationManager
{
    ...
    enum Error: LocalizedError, RecoverableError
    {
        ...
        var failureReason: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return NSLocalizedString("misaka requires “Always” location permission.", comment: "")
            }
        }
        ...
        var recoverySuggestion: String? {
            switch self
            {
            case .requiresAlwaysAuthorization: return NSLocalizedString("Please grant misaka “Always” location permission in Settings so it can run in the background indefinitely.", comment: "")
            }
        }
...
class LocationManager: NSObject, ObservableObject
{
    ...
    override init()
    {
        ...
        self.locationManager.showsBackgroundLocationIndicator = SettingsManager.shared.StatusBarIndicator
...
extension LocationManager: CLLocationManagerDelegate
{
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation])
    {
        ...
        Location.shared.latitude = latestLocation!.coordinate.latitude
        Location.shared.longitude = latestLocation!.coordinate.longitude
