...
{
    case appStoppedRunning = "com.straight-tamago.misaka.AppStoppedRunning"
}

private extension CFNotificationName
{
    static let altstoreRequestAppState: CFNotificationName = CFNotificationName("com.misaka.RequestAppState.com.straight-tamago.misaka" as CFString)
    static let altstoreAppIsRunning: CFNotificationName = CFNotificationName("com.misaka.AppState.Running.com.straight-tamago.misaka" as CFString)
}
...
private extension ApplicationMonitor
{
    ...
    func scheduleApplicationQuitNotification()
    {
        ...
        content.title = MILocalizedString("App Stopped Running")
